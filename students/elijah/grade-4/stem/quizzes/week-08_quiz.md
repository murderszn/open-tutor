...
4) A toy car takes 5 s to go 10 m. Average speed?
5) Name one example of reflection.
6) Name one body system and what it does.
7) Draw a simple wave with two crests.
