...
4) Explain conduction vs convection.
5) A 6 kg object under 3 N net force: acceleration?
6) Compare transverse vs longitudinal waves with examples.
7) Define homeostasis with an example from human physiology.
