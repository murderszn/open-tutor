...
## How To Read This
- Education: typical minimum (some roles accept experience/certs instead).
- Specialty: example focus areas or credentials.
- Pay (US est.): ballpark range for total comp or salary. Verify with BLS/O*NET/market sites.
- Sources: BLS Occupational Outlook Handbook (OOH), O*NET, and reputable salary sites.

Education key: HS = High School; Cert = Certificate/Apprenticeship; AA/AS = Associate (2‑yr); BA/BS = Bachelor (4‑yr); MS/MEng/MBA = Master; PhD/MD/JD/DO = Doctor/Professional.
