...
- Convert prices between currencies using a real rate and show your math. Record the source/date.
- Compare APR vs APY on a savings product. Which grows money faster and why?
- Build a tiny ETF portfolio (e.g., US total stock + international) on paper. Explain your mix and rebalancing rule.
- Calculate a sample mortgage payment and total interest paid over the loan’s life.
- Budget drill: list monthly income, fixed costs, variable costs, and planned savings (pay yourself first).
